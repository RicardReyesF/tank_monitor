...
class RadialPageT extends StatefulWidget {
final porcentaje;

  const RadialPageT({ this.porcentaje});

  @override
  _RadialPageTState createState() => _RadialPageTState();
}


class _RadialPageTState extends State<RadialPageT> with SingleTickerProviderStateMixin{
  ...
  Widget build(BuildContext context) {
    ...
    return AnimatedBuilder(
      ...
      child: Center(
        ...
        child: Text((widget.porcentaje).round().toString() + " C°",style: TextStyle(color: Colors.orange,fontSize: 75.0),),
      )
      )
    );
  }
